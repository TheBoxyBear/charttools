...
The library is fully usable at its current state with all major features present. The first proper release should happen at some point in November alongside a charting utility. The library will continue to be updated during the developpement of the utility.
