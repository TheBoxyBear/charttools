...
internal static class AnimationMapper
{
    ...
    public static NoteMapping MapHandPosition(StandardInstrumentHandPosition handPosition) => new(handPosition.Position, NoteState.Open, new((byte)(handPosition.Index + 39)));
}
