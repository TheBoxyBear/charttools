...
namespace ChartTools.Optimization
{
    ...
    public static class Optimizer
    {
        ...
        public static void CutSustains<TNote, TNoteEnum>(this IEnumerable<Chord<TNote, TNoteEnum>> chords) where TNote : Note where TNoteEnum : System.Enum => chords.OrderBy(c => c.Position).RelativeLoop((previous, current) =>
        {
