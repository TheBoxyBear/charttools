...
{
	/// <inheritdoc cref="VerbalEnumerate(string, ReadOnlySpan{string})"/>
	public static string VerbalEnumerate(this IEnumerable<string> items, string lastItemPreceder)
		=> VerbalEnumerate(lastItemPreceder, [.. items]);
	...
	public static string VerbalEnumerate(string lastItemPreceder, ReadOnlySpan<string> items)
		=> items.Length switch
		{
			0 => string.Empty, // ""
			1 => items[0], // "Item1"
