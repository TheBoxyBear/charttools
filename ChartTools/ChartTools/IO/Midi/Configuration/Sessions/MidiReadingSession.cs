...
internal class MidiReadingSession(MidiReadingConfiguration? config, FormattingRules? formatting)
	: MidiSession(formatting)
{
	...
	public InstrumentSpecialPhrase? HandleMisalignedBigRock(IEnumerable<InstrumentSpecialPhrase> endings)
		=> Configuration.MisalignedBigRockMarkersPolicy switch
		{
	...
	public bool HandleMissingBigRock()
		=> Configuration.MissingBigRockMarkerPolicy switch
		{
