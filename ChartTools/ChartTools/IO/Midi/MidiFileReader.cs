...
internal class MidiFileReader(string path, Func<string, MidiParser?> parserGetter, ReadingSettings? settings)
	: FileReader<MidiEvent, MidiParser>(path, parserGetter)
{
	public ReadingSettings? Settings { get; } = settings;
