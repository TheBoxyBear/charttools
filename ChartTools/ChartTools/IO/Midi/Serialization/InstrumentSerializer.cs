...
internal class InstrumentSerializer<TChord>(string header, Instrument<TChord> content, AnimationSet animations, MidiWritingSession session)
	: TrackObjectGroupSerializer<Instrument<TChord>>(header, content, session)
