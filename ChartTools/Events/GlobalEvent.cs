...
public class GlobalEvent : Event
{
	...
	/// </summary>
	public bool IsBassistMovementEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.BassistMovement);

	/// <summary>
	/// The event controls movement of the crowd
	/// </summary>
	public bool IsCrowdEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.Crowd);

	/// <summary>
	/// The event controls movement of the drummer character on stage
	/// </summary>
	public bool IsDrummerMovementEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.DrummerMovement);
	...
	public bool IsGuitaristSoloEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.GuitaristSolo);

	/// <summary>
	/// The event controls movement of the keyboard player character on stage
	/// </summary>
	public bool IsKeyboardMovementEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.KeyboardMovement);
	...
	/// </summary>
	public bool IsPhraseEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.Phrase);

	/// <summary>
	/// The event represents a section of a song used for post-game summary and practice mode
	/// </summary>
	public bool IsSectionEvent
		=> EventType is EventTypeHelper.Global.RB2CHSection or EventTypeHelper.Global.RB3Section;

	public bool IsSyncEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.Sync);

	public bool IsWailEvent
		=> EventType.StartsWith(EventTypeHeaderHelper.Global.GuitaristWail);
