...
internal static class ValueParser
{
	...
	public static T Parse<T>(string? value, string target, TryParse<T> tryParse) where T : struct
		=> tryParse(value, out T result) ? result : throw new ParseException(value, target, typeof(T));
