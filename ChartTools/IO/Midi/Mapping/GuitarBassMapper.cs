...
internal class GuitarBassMapper : StandardInstrumentMapper, IAnimationContainer<HandPositionEvent>
{
    ...
    public GuitarBassMapper(MidiReadingSession session) : base(session) { }
    public GuitarBassMapper(MidiWritingSession session, MidiInstrumentOrigin writingFormat, IEnumerable<HandPositionEvent> handAnimations) : base(session)
    {
