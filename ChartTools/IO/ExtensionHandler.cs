...
internal static class ExtensionHandler
{
	...
	private static ArgumentException GetException(string extension, IEnumerable<string> supportedExtensions)
		=> new($"\"{extension}\" is not a supported extension. File must be {supportedExtensions.VerbalEnumerate("or")}.");
}
